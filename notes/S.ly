...
CanticumSoprano = {
  \relative c' {
    ...
    R1*22 %22
    r8 \mvTr g''\fE^\tuttiE fis e d4. c8
    h g' fis e d4. c8
    h4 r c c8 c %25
    c8. h16 h8 g e'4 e
    e8. d16 d8 d fis,4 g
...
CanticumSopranoLyrics = \lyricmode {
  Can -- te -- mus Do -- mi -- %23
  no, can -- te -- mus Do -- mi --
  no, te -- la fu -- %25
...
LaudateSoprano = {
  \relative c' {
    ...
    g r r2
    \after 4*5 \tempoLaudateB R1*5 %23
    \mvTr f4.\pE^\LevitaPrimus b8 b4 a
    c4. es8 es4 d %25
    f4. d8 g([ h,)] c([ d)]
    es4. g8 f([ a,)] b r
    d4. f8 \appoggiatura es d4 d8 f
    \appoggiatura es d4 d c8([ g' es)] c
    b4( a) b r %30
    R1*4
    c4. a8 es'([ c)] d4 %35
    c4. a8 es'([ c)] d4
    ...
    es4. g8 f([ a,)] b r
    d4. f8 \appoggiatura es d4 d8 f
    \appoggiatura es d4 d c8([ g' es)] c %40
    b4( a) b r
    R1*4 %45
